...
app.post('/users/signup', function(req, res) {
    ...
    user_controller.signup(params here);
});

app.post('/ingredients/add', function(req, res) {
    //example
    //process req, res to get stuff
    ingredient_controller.add(params here);
});

app.post('/ingredients/remove', function(req, res) {
    //example
    //process req, res to get stuff
    ingredient_controller.remove(params here);
});

app.post('/ingredients/removeAll', function(req, res) {
    //example
    //process req, res to get stuff
    ingredient_controller.removeAll(params here);
});

app.post('/search', function(req, res) {
    //example
    //process req, res to get stuff
    search_controller.search(params here);
});

app.get('/getRecipeData', function(req, res) {
    //example
    //process req, res to get stuff
    search_controller.signup(params here);
});

app.get('/history', function(req, res) {
    //example
    //process req, res to get stuff
    history_controller.get(params here);
});

app.post('/make', function(req, res) {
    //example
    //process req, res to get stuff
    history_controller.make(params here);
});
